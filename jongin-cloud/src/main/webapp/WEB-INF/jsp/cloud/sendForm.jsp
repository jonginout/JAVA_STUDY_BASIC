...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    ...
    <form method="post" name="smsForm" action="${pageContext.request.contextPath}/cloud/smsSend.do">
        ...
        <input type="hidden" name="sphone2" value="4021">
        <input type="hidden" name="sphone3" value="6749">
